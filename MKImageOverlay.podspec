#
#  Be sure to run `pod spec lint MKImageOverlay.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "nickolanack"
  # s.authors            = { "nickolanack" => "nickblackwell82@gmail.com" }
  # s.social_media_url   = "http://twitter.com/nickolanack"
  ...
  s.source       = { :git => "https://github.com/nickolanack/ios-mapkit-groundoverlay.git", :tag => '0.0.1'}
